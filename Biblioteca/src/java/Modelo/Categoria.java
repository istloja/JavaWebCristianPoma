...
@NamedQueries({
    ...
    , @NamedQuery(name = "Categoria.findByLibroIdLibro", query = "SELECT c FROM Categoria c WHERE c.libroIdLibro = :libroIdLibro")})
public class Categoria implements Serializable {
    ...
    public Categoria(Integer idcategoria, String nombre, int libroIdLibro) {
        this.idcategoria = idcategoria;
        this.nombre = nombre;
